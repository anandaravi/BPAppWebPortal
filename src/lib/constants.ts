export const SITE = {
  ...
  whatsappMessage: "Hi, I'd like to know more about Papyrus BPApp for my paper mill.",
  ...
  keywords: [
    ...
    "paper trim optimization",
    "paper manufacturing software India",
    "GST ERP paper mill",
    "kraft paper ERP",
    "tissue paper manufacturing software",
    "newsprint mill management",
    "Greycon alternative",
    "SAP paper mill alternative",
    "Tally alternative paper industry",
    "Indian paper manufacturing ERP",
    "MES paper mill",
    "production planning paper",
    "paper machine OEE",
    "paper mill software Vapi",
    "paper mill software Coimbatore",
    "Papyrus BPApp",
  ],
};
