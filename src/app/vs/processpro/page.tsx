...
const data: ComparisonPageData = {
  ...
  faqs: [
    ...
    { q: "What's Papyrus BPApp's paper-industry track record vs ProcessPro's North American base?", a: "Papyrus BPApp is developed by Netique Infotech Pvt Ltd. — pioneers of Deckle Matching software in India, serving paper mills since 2000 with a consulting team carrying 35+ years of paper-industry experience and 20+ years of multi-country mill deployments. Prior products (NDM, Paper Agent, Optrim, Optrim Web, Papyrus Production Manager) have been deployed in Indian and overseas mills for two decades. Delivered under the Papyrus360 brand. Different region than ProcessPro's primary market, but equivalent depth on paper-specific operations and unmatched India compliance fit." },
  ],
};
