    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[var(--container-max)] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-5 text-text-2 leading-relaxed text-base">
                <p>
                ...
                <p>
                  ...
                  delivered under the{" "}
                  <span className="text-foreground font-semibold">Papyrus360</span>{" "}
            ...
            >
              {STATS.map((stat, i) => (
                <motion.div
                  ...
                  className="bg-surface border border-border-dim rounded-2xl p-7 flex flex-col gap-2"
                >
      ...
      <section className="py-20 border-b border-border-dim">
        <div className="max-w-[var(--container-max)] mx-auto px-6">
          ...
          <p className="text-text-2 text-base max-w-3xl mb-12 leading-relaxed">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={step.product} className="flex gap-5 items-start">
                  <div
                    className="flex-shrink-0 w-14 h-14 rounded-full bg-surface border-2 flex items-center justify-center font-mono text-[10px] font-bold"
                    style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              >
                ...
                <h3 className="text-foreground font-bold text-base">{p.title}</h3>
                <p className="text-sm text-text-2 leading-relaxed flex-1">{p.desc}</p>
                <p className="text-[10px] font-mono uppercase tracking-widest pt-2 border-t border-border-dim"
                  style={{ color: p.color }}
                >
                  {p.meta}
                </p>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-3">
            {[
              ...
              >
                ...
                <p className="text-xs text-text-3 leading-relaxed">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            {DIFFERENTIATORS.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-surface border border-border-dim rounded-2xl p-7 flex flex-col gap-5 hover:border-amber-500/20 transition-colors"
                >
                  <div
                  ...
                  <div>
                    <h3 className="text-foreground text-xl font-black mb-3">
                      {item.title}
                    </h3>
            ...
            {APPROACH.map((item, i) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.4, delay: i * 0.1 }}
                  className="bg-surface border border-border-dim rounded-2xl p-7 hover:border-amber-500/20 transition-colors"
                >
                  <div
      ...
      {/* COMPLIANCE STRIP */}
      <section className="py-14 bg-background border-b border-border-dim">
        <div className="max-w-[var(--container-max)] mx-auto px-6">
          <p className="text-center text-text-3 text-xs font-semibold uppercase tracking-widest mb-8">
