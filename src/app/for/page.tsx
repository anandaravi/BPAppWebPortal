        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {MILL_TYPES.map((m) => (
            <Link
              key={m.slug}
              href={`/for/${m.slug}`}
              className="group block bg-[#0f0f0f] border rounded-2xl p-6 hover:border-amber-500/30 transition-colors"
            ...
            >
              ...
              <h3 className="text-xl font-black text-white mb-2 group-hover:text-amber-300 transition-colors">{m.name}</h3>
